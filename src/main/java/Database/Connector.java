...
public class Connector{
    ...
    private static final String DATABASE_URL = "jdbc:mysql://127.0.0.1:3306/project?allowPublicKeyRetrieval=true&useSSL=false";
    private static final String USERNAME = "root";
    private static final String MAX_POOL = "250";

    private static String PASSWORD = "Projectoop2023/*";
    ...
    public static void Raw(String statement){
